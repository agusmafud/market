...
const steps = ['Tus datos', 'Día y lugar de entrega', 'Revisá tu pedido'];
                                                        ...
                                                        <Grid container spacing={24}>
                                                            <Grid item xs={12}>                                                                      
                                                                <Field                                                                 
                                                                    ...
                                                                    fullWidth type="text" component={TextField} name="name" 
                                                            ...
                                                            <Grid item xs={12}>                                                                
                                                                <Field 
                                                                    ...
                                                                    fullWidth type="tel" minLength='5' maxLength='12' component={TextField} 
                                                            ...
                                                            <Grid item xs={12}>                                                                
                                                                <Field 
                                                                    ...
                                                                    fullWidth type="email" component={TextField} name="email" 
                                                ...
                                                }
                                                {
                                                    activeStep === 1 && (
                                                        <Grid container spacing={24}>                                                                                                        
                                                            <Grid item xs={12}>
                                                                { 
                                                                    (validationStep === 2) && errors.entregaDia ?
                                                                        <Typography id='diasSelect' variant="subtitle2" align='center' gutterBottom style={{fontSize: 20, color: 'red'}}>
                                                                            Elegí un día de entrega...
                                                                        </Typography>
                                                                    :
                                                                        <Typography id='diasSelect' variant="subtitle2" align='center' gutterBottom style={{fontSize: 20}}>
                                                                            Elegí un día de entrega...
                                                                        </Typography>
                                                                }                                                            
                                                                <Field validate={isRequired} name="entregaDia" component={RadioGroup} className={classes.radioGroup} >
                                                                    <FormControlLabel
                                                                        value='1'
                                                                        control=
                                                                        {
                                                                            <Radio
                                                                                onClick={scrollToHorasSelect} 
                                                                                icon={ 
                                                                                    <Button 
                                                                                        className={classes.botonOpcion}
                                                                                        style={{                                                                                        
                                                                                            color: (validationStep === 2) && errors.entregaDia ? 'red' :'',
                                                                                            borderColor: (validationStep === 2) && errors.entregaDia ? 'red' :''
                                                                                        }} 
                                                                                    variant="outlined">{calcularDiaSemana(0)}</Button>                                                                                
                                                                                }
                                                                                checkedIcon={                                                                                
                                                                                    <Button className={classes.botonOpcion} variant="contained" color='primary'>{calcularDiaSemana(0)}</Button>                                                                                
                                                                                }                                                                            
                                                                            />
                                                                        }
                                                                    />
                                                                        ...
                                                                        control=
                                                                        {
                                                                            <Radio
                                                                                ...
                                                                                icon={ 
                                                                                    ...
                                                                                    variant="outlined">{calcularDiaSemana(1)}</Button>                                                                                
                                                                                }
                                                                                checkedIcon={                                                                                
                                                                                    <Button className={classes.botonOpcion} variant="contained" color='primary'>{calcularDiaSemana(1)}</Button>                                                                                
                                                                                }                                                                            
                                                                            />
                                                                        }
                                                                    />
                                                                        ...
                                                                        control=
                                                                        {
                                                                            <Radio
                                                                                ...
                                                                                icon={ 
                                                                                    ...
                                                                                    variant="outlined">{calcularDiaSemana(2)}</Button>                                                                                
                                                                                }
                                                                                checkedIcon={                                                                                
                                                                                    <Button className={classes.botonOpcion} variant="contained" color='primary'>{calcularDiaSemana(2)}</Button>                                                                                
                                                                                }                                                                            
                                                                            />
                                                                        }
                                                                    />
